 ...
 */
public final class QueueAbleCachedThreadPool extends java.util.concurrent.ThreadPoolExecutor {
	...
	protected static class ControllableQueue extends LinkedBlockingQueue<Runnable> {
		...
		private transient volatile QueueAbleCachedThreadPool parent = null;
