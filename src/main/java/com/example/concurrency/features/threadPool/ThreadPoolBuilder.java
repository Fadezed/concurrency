...
public class ThreadPoolBuilder {
	...
	public static class QueueAbleCachedThreadPoolBuilder {
		...
		public QueueAbleCachedThreadPool build() {
			...
			return new QueueAbleCachedThreadPool(minSize, maxSize, keepAliveSecs, TimeUnit.SECONDS,
					new QueueAbleCachedThreadPool.ControllableQueue(queueSize), threadFactory, rejectHandler);
		}
	}
